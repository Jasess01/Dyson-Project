...
public class DysonLevelManager : LevelManager
{
    /// <summary>
    ...
    protected static new DysonLevelManager _instance;

    public static new DysonLevelManager Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = FindObjectOfType<DysonLevelManager>();
                if (_instance == null)
                {
                    GameObject obj = new GameObject();
                    _instance = obj.AddComponent<DysonLevelManager>();
                }
            }
            return _instance;
        }
